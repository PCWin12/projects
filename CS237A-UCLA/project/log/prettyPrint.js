...
Add.prototype.prettyPrint = function(strm) {
  strm.write('new Add( ');
  strm.indentFromHere();
  this.e1.prettyPrint(strm)
  strm.dedent();
  strm.write(' , ')
  strm.indentFromHere();
  this.e2.prettyPrint(strm);
  strm.dedent();
  strm.write(' )')
};
...
Sub.prototype.prettyPrint = function(strm) {
  strm.write('new Sub( ');
  strm.indentFromHere();
  this.e1.prettyPrint(strm)
  strm.dedent();
...
Mul.prototype.prettyPrint = function(strm) {
  strm.write('new Mul( ');
  strm.indentFromHere();
  this.e1.prettyPrint(strm)
  strm.dedent();
...
Pow.prototype.prettyPrint = function(strm) {
  strm.write('new Pow( ');
  strm.indentFromHere();
  this.e1.prettyPrint(strm)
  strm.dedent();
...
Mod.prototype.prettyPrint = function(strm) {
  strm.write('new Mod( ');
  strm.indentFromHere();
  this.e1.prettyPrint(strm)
  strm.dedent();
...
Comp.prototype.prettyPrint = function(strm) {
  strm.write('new Comp( ' + this.op + ' , ');
  strm.indentFromHere();
  this.e1.prettyPrint(strm);
  strm.dedent();
  strm.write(' , ');
