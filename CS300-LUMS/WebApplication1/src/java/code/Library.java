...
public class Library implements LibraryInfo {
    ...
    public void getLibraryStats() {
        ...
        System.out.println("\t\t\t\t*** Library System Stats ***<br><br>No. of Users:\t" + users.size());
        System.out.println("\tAdministrators: " + admin + "<br>\tFaculty: " + faculty + "<br>\tStudents: " + students);

        System.out.println("<br>Number of Resources: " + resources.size() + "<br>\tBooks: " + books + "<br>\tCourse Packs: "
                + course_packs + "<br>\tMagazines: " + magazines);

        System.out.println("<br>\tItems Issued: " + issued + "<br>\tItems Overdue: " + overdue + "<br>\tTotal Requests: " + request);
    }
    /*
    ...
    public void getLibraryStats(PrintWriter out) {
        ...
        //output all the stats.
        out.println("\t\t\t\t*** Library System Stats ***<br><br>No. of Users:\t" + users.size());
        out.println("\tAdministrators: " + admin + "<br>\tFaculty: " + faculty + "<br>\tStudents: " + students);

        out.println("<br>Number of Resources: " + resources.size() + "<br>\tBooks: " + books + "<br>\tCourse Packs: "
                + course_packs + "<br>\tMagazines: " + magazines);

        out.println("<br>\tItems Issued: " + issued + "<br>\tItems Overdue: " + overdue + "<br>\tTotal Requests: " + request);
    }
