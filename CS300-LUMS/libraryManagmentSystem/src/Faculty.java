...
public class Faculty extends LibraryUser implements Borrower {
	...
	public Faculty(String username, String _password) {
		super.userName = username;
		super.password = _password;
		super._type = Constants.FACULTY;
	...
	public void viewRequests() {
		...
		for (LibraryResource temp : requestsMade) {
			Main.print(temp.resourceID + "  " + temp.resourceName);
		}
	...
	public void viewIssued() {
		...
		for (LibraryResource temp : issuedResources) {
			...
			if (temp.type == Constants.BOOK) {
				pr = temp.resourceID + "  " + temp.resourceName
						+ " Type : Book";
			} else {
				pr = temp.resourceID + "  " + temp.resourceName
						+ " Type : CoursePack";
